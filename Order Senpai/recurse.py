...
with open("/home/ubuntu/Spinettis/chiporders.txt") as f:
   lines = f.read().splitlines()
f.close()

with open('/home/ubuntu/Spinettis/chiporders.txt', 'r') as filehandle:
...
while u < 25:
    stru = str(u)
    url = ("https://api.sellbrite.com/v1/orders?page=" + stru + "&limit=100")
    print(url)
    print(u)
    headers = {
